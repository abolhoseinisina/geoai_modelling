...
MODELS = [
    ...
    ModelSpec("FINE-TUNED MASK-RCNN", Path("output/models/finetune/finetuned_building_footprints_usa_24ep_20260917.pth"), "MASK-RCNN", tile_size=640, overlap=64, gsd_m=0.1),
    ModelSpec("FINE-TUNED MASK-RCNN (ONNX)", Path("output/models/finetune/finetuned_building_footprints_usa_24ep_20260917.onnx"), "MASK-RCNN-ONNX", tile_size=640, overlap=64, gsd_m=0.1),
